  ...
  <form role="form"  method="post">
    ...
    <!--         <select name="tiene_cartilla_salud" class="form-control" required>
      ...
      <!-- FIN DEL SELECT PARA LABORATORIO -->
        ...
        <div class="form-group col-md-6 ">
          <label for="otros_hallazgos">B. Otros hallazgos:</label>
...
<!--         <div class="form-group col-md-6 ">
          <label for="diagnostico_citologico">Diagnóstico citológico Bethesda:</label>
        ...
        <div class="form-group col-md-6 ">
          <label for="otros_hallazgos">Otros Hallazgos:</label>
            <input type="text" class="form-control" id="otros_hallazgos" name="otros_hallazgos" value="NINGUNO" readonly>
        </div> -->
        <div class="form-group col-md-6 ">
        ...
        <div class="form-group col-md-4 ">
          <label for="repetir_estudio">Repetir estudio:</label>
            <select name="repetir_estudio" id="repetir_estudio" class="form-control" disabled>
             <!--  <option value="NO CAPTURADO">Selecciona Opción</option> -->
              <option value="SI">1. Si</option>
         ...
         <div class="form-group col-md-8 " >
          ...
          <input type="text"  class="form-control" id="diagnostico_patologo" name="diagnostico_patologo" placeholder="<?php echo $data['diagnostico_patologo'] ?>">
        </div>

        <div class="form-group col-md-12 " >
          <label for="cedula_patologo">RFC profesional del patólogo (a):</label>
          <input type="text"  class="form-control" id="cedula_patologo" name="cedula_patologo" placeholder="<?php echo $data['cedula_patologo'] ?>">
        </div>
