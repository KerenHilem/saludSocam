...
<div class="container">
 <div class="row">
 	  <h2 class="col-md-10">Estudio Integral</h2>
    ...
    //variables de sesion
      ...
      $variable_auxiliar = (array) $_POST["estudios_a_realizar"]; 
      $estudios_a_realizar=implode(', ', $variable_auxiliar);
      //$_SESSION['estudios_a_realizar']=$estudios_a_realizar;
      //var_dump($estudios_a_realizar);
      //echo strlen($estudios_a_realizar);     

    if(isset($_POST['submit'])){

      include("../create/datosPaciente.php");
      //include("../create/citologia.php"); aun no funciona
      ...
      //insertar citologia
      $query = $mysqli->query("INSERT INTO citologia VALUES('', '$unidad_id',(SELECT id FROM pacientes WHERE 
        nombre='$nombre' AND apellido_pat='$apellido_pat' AND apellido_mat='$apellido_mat' AND 
