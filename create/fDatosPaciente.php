...
<div class="form-group col-md-12">
   ...
   <!-- <form name="contact" id="contact" method="post"> -->
         <!-- Número : <input type="text" name="numero" id="numero" value="215249" /><br/> -->
    <div class="form-group col-md-2">
      <label for="numero_expediente_electronico">No. Expediente:</label>
      <input type="number" class="form-control" id="numero_expediente_electronico" name="numero_expediente_electronico" value="215249" placeholder="Número de Expediente">
      
    </div>            
    
    <div class="form-group col-md-1">
      <label for="numero_expediente_electronico">&nbsp;</label>
      <input type="button" value="Buscar" name="buscar_expediente" id="buscar_expediente" class="btn btn-default "/>
    </div>
    <!-- </form> -->

    <div class="form-group col-md-3 hidden">
      <label for="cicam_clave">No. Expediente:</label>
      <input type="text" class="form-control" id="cicam_clave" name="cicam_clave" placeholder="">
    </div>
     
    <div class="form-group col-md-3">
      <label for="nombre_paciente">Nombre:</label>
      <input type="text" class="form-control" id="nombre_paciente" name="nombre" onKeyUp="this.value=this.value.toUpperCase();" required>
    </div>
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="municipio_nacimiento" name="municipio_nacimiento"onKeyUp="this.value=this.value.toUpperCase();" required>
    </div>
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="calle" name="calle" onKeyUp="this.value=this.value.toUpperCase();" required>
    </div>
    ...
    <div class="form-group col-md-3">
      <label for="localidad">Localidad:</label>
       <!--  <select name="localidad" class="form-control" > -->
        ...
        <!-- </select>     -->
        <input type="text" class="form-control" id="localidad" name="localidad" placeholder="Escribe localidad si no existe dejar en blanco" onKeyUp="this.value=this.value.toUpperCase();">
    </div>
 ...
 <!--      <input type="text" class="form-control" id="delegacion" name="delegacion" onKeyUp="this.value=this.value.toUpperCase();"> -->
    ...
    <div class="form-group col-md-3">
      <label for="entidad_federativa">Entidad Federativa (Estado):</label>
        <select name="entidad_federativa" class="form-control" >
          <option value="AGUASCALIENTES">AGUASCALIENTES</option>
          <option value="BAJA CALIFORNIA" selected>BAJA CALIFORNIA</option>
          <option value="BAJA CALIFORNIA SUR">BAJA CALIFORNIA SUR</option>
          <option value="CAMPECHE">CAMPECHE</option>
    ...
    <div class="form-group col-md-3">
      ...
      <select name="jurisdiccion_id" class="form-control" id="jurisdiccion_id">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="number" class="form-control" id="num_poliza" name="num_poliza" min="0" required>
    </div>
