...
<div class="container">
 <div class="row">
    ...
    if(isset($_POST['submit'])){
      ...
      $query = $mysqli->query("insert into hojas_resumen values('','$unidad_id','$total_muestras','$muestras_rango1','$muestras_rango2','$muestras_inadecuadas','$muestras_fuera_rango', NOW(), NOW())");
   if($query){
        ?>
    ...
    <form role="form"  method="post">
     <h3>Citología Cervical</h3>
        <div class="form-group col-md-12">
         ...
         <div class="form-group col-md-12">
          <label for="muestras_rango1">Muestras Rango 1 de 25 a 34 años:</label>
          <input type="number" min="0" class="form-control" id="muestras_rango1" name="muestras_rango1" placeholder="Ingresa Número">
        </div>

         <div class="form-group col-md-12">
          <label for="muestras_rango2">Muestras Rango 2 de 35 a 64 años:</label>
        ...
        <div class="form-group col-md-12">
          <label for="muestras_fuera_rango">Lamina Inadecuada para envío al laboratorio:</label>
          <input type="number" min="0" class="form-control" id="muestras_fuera_rango" name="muestras_fuera_rango" placeholder="Ingresa Número">
        </div>
