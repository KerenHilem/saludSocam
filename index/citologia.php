...
<section> 
  <div class="container">
       <div class="col-md-10">
        <h2>Resumen de Citologias</h1>
      </div>
      <div class="col-md-2 text-right">
        <h1><a href="../create/createCitologiaCompleto.php" class="btn btn-primary"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Agregar Nueva Citología</a></h1>
      </div>
